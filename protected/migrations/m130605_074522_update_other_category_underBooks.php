...
class m130605_074522_update_other_category_underBooks extends DTDbMigration {
    ...
    public function up() {
        ...
        $sql.= " WHERE 
                (category_name  <> 'Quran' OR 
                    category_name  <> 'Educational Toys' OR 
                    category_name  <> 'Others' OR 
                    category_name  <> 'Books' OR
                    category_name  <> 'quran' 
                ) ";
        ...
        foreach ($categories as $row) {
            ...
            $this->update($table, array("parent_id" => $category['category_id']));
        }
    }
