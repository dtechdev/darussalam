...
INSERT INTO `region` (`id`, `iso`, `iso3`, `fips`, `country`, `continent`, `currency_code`, `currency_name`, `phone_prefix`, `postal_code`, `languages`, `geonameid`) VALUES
...
(418, 'LA', 'LAO', 'LA', 'Laos regions', 'AS', 'LAK', 'Kip', '856', '^(d{5})$', 'lo,fr,en', '1655842'),
...
INSERT INTO `subregion` (`id`, `region_id`, `name`, `timezone`) VALUES
