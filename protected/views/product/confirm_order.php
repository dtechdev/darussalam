                        ...
                        <table width="100%">
                            ...
                            <tr class="right_cart_tr">
                                ...
                                if($_REQUEST['type']=='paypal')
                                {
                                    ...
                                    ?>
                                    <a href="<?php echo  $this->createUrl('/Paypal/buy');?>"><input type="button" value="Place Order" class="check_out" /></a>
                                    <?php
                                }else
                                    {
                                    ?>
                                    <a href="<?php echo  $this->createUrl('/Paypal/directpayment');?>"><input type="button" value="Place Order" class="check_out" /></a>
                                    <?php }?>
                  	</div>
                </div>
           	</div>
