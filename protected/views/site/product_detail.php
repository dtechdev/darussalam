<div id="book_content">
    ...
    <div id="descritpion">
        <div id="booked_content">
        	<div class="left_book">
            	<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/WQS-Book-04_03.jpg" />
            </div>
            <div class="right_book">
                ...
                <table width="400">
                    ...
                    <tr>
                    	<td class="left_td">More Languages:</td>
                        <td class="right_td">Arabic\Hindi\Persian</td>
                    </tr>
                    <tr>
                    	<td class="left_td">Category:</td>
                        <td class="right_td">Stories</td>
                    </tr>
                    <tr>
                    	<td class="left_td">Writer:</td>
                        <td class="right_td">Abdul Malik Mujahid</td>
                    </tr>
                    <tr>
