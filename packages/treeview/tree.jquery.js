        ...
        JqTreeWidget.prototype._refreshElements = function(from_node) {
            ...
            createNodeLi = function(node) {
                ...
                if (typeof(node.type) != "undefined") {
                    if (node.type == "file") {
                        css_class = ' class="file_class"';
                        type = ' type="file"';

                    }
                    else if (node.type == "folder") {
                        css_class = ' class="folder_class"';
                        type = ' type="folder"';
                    }
                }
                return $("<li" + node_id + " " + css_class + " " + type + "><div><span class=\"title\">" + escaped_name + "</span></div></li>");
            };
            createFolderLi = function(node) {
                ...
                return $("<li " + node_id + " "+ftype+" class=\"" + folder_class + "\"><div><a class=\"" + button_class + "\">&raquo;</a><span class=\"title\">" + escaped_name + "</span></div></li>");
            };
