...
if (!empty($product->other[0])) {
    if (!empty($product->other[0]->productImages[0])) {
        $detail_img = CHtml::image($product->other[0]->productImages[0]->image_url['image_large'], '', array("class" => "small_product_first", "id" => "large_image",));
    ...
    <div class="small_product">
        <?php
        foreach ($product->other[0]->productImages as $img) {
