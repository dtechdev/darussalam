<div id="landing_content">
    ...
    <div class="landing_main_div">
        ...
        <div class="landing_div">
            <?php
            echo CHtml::link(CHtml::image(Yii::app()->theme->baseUrl . "/images/educational_toys_img_03.png"), $this->createUrl('/web/product/allproducts'));
            ?>
        ...
        <div class="landing_div">
            <?php
            echo CHtml::link(CHtml::image(Yii::app()->theme->baseUrl . "/images/other_items_img_03.png"), $this->createUrl('/web/product/allproducts'));
            ?>
            <h4>Other Items</h4>
            <article>Lorem ipsum color sit bla bla thhm ipoum deona eio a ea sho moxnt</article>
            <input type="button" value="Shop Now" class="shop_now" />
